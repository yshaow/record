...
<html lang="en">
<head>
    <title>Code coverage report for ogr2ogr/modules/util.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">ogr2ogr/modules/</a> util.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  return function() {
    expect++, total++
    return function(er) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (er) <span class="cstat-no" title="statement not covered" >return one(er)</span>
